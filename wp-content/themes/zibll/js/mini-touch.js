 ...
 * @LastEditTime: 2020-12-22 20:06:48
...
function cssTransition(a, b, c, d, s) {
    var e, f, g;
...
$.fn.minitouch = function (options) {
    ...
    _e.on('touchstart pointerdown MSPointerDown', options.selector, function (e) {
        ...
        .on('touchend touchcancel pointerup MSPointerUp', options.selector, function (e) {
            if (dragging) {
                ((Math.abs(distanceX) > dep || Math.abs(distanceY) > dep) && 0 != options.onEnd) && options.onEnd(_e), cssTransition($(this), 0, 0, "null", ''),
                    dragging = !1,
                    startX = 0,
                    startY = 0,
                    endX = 0,
